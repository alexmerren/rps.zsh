...
// GetStarredRepositories provides a mock function with given fields:
func (_m *GithubInteractor) GetStarredRepositories() ([]byte, error) {
	ret := _m.Called()
...
// GetUserRepositories provides a mock function with given fields:
func (_m *GithubInteractor) GetUserRepositories() ([]byte, error) {
	ret := _m.Called()
...
func NewGithubInteractor(t interface {
	mock.TestingT
	Cleanup(func())
}) *GithubInteractor {
